    ...
    <header className='py-8'>
      <div className='container mx-auto'>
        <div className='flex justify-between items-center'>
          ...
          <a href='https://nipuna-nadeeshan..netlify.app'> <img src={Logo} alt='' style={{ width: '85px', height: 'auto' }} /> </a>
          <Link to='contact' activeClass='active' smooth={true} spy={true} >

            <a onClick={() => window.location.href = 'mailto:nipunanadeeshan2000@gmail.com?subject=Lov%20ur%20skills%20set'}
